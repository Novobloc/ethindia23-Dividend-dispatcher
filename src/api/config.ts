...
export const urlConfig = {
  token: {
    GET_TOKEN_LIST: "/token/v1.2/${chainId}/token-list?provider=${provider}"
  },
  portfolio: {
  ...
  history: {
    GET_TRANSACTIONS: (address: string) => `${url}/history/v2.0/history/0x5B4d77e199FE8e5090009C72d2a5581C74FEbE89/events?limit=12&chainId=137`
  }
};
