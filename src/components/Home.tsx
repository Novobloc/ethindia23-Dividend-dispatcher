            ...
            <div className="w-full md:w-1/2 md:px-3">
              <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-4xl md:text-4xl lg:text-4xl xl:text-4xl">
                  <span className="block font-sans font-normal xl:inline text-7xl">Data to enrich your online business</span>
                  <br /> <br />
                ...
                <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                  <Link
                    to="/app"
                    className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white rounded-md sm:mb-0 hover:bg-indigo-700 bg-black  sm:w-auto">
                    Launch App
                    <svg
