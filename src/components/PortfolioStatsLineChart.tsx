...
import { lineChartDataTotalSpent, lineChartOptionsTotalSpent } from "constants/charts";
    ...
    <Card extra="p-[20px] text-center">
      ...
      <div className="flex h-full w-full flex-row justify-between sm:flex-wrap lg:flex-nowrap 2xl:overflow-hidden">
        ...
        <div className="h-full w-full">
          <LineChart chartOptions={lineChartOptionsTotalSpent} chartData={lineChartDataTotalSpent} />
        </div>
      </div>
    </Card>
  );
...
export default PortfolioStatsLineChart;
